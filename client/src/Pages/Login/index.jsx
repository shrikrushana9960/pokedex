...
const Login = () => {
  ...
  const responseFacebook = (response) => {
    ...
    fetch("https://pockemon-task.herokuapp.com/api/facebookLogin", {
      method: "POST",
      body: JSON.stringify({ email:response.userID+"@facebook",token:response.accessToken, password:"pocodoc",name:response.name }),
      headers: {
      ...
      .then((res) => {
        ...
        localStorage.setItem("email", response.userID+"@facebook");
        console.log("here");
        history.push("/home");
